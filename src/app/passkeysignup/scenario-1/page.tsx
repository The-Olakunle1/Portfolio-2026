...
const SCENARIOS = [
  { id: "S1", label: "S1 — Instant detection, passkey supported", href: "/passkeysignup/scenario-1" },
  { id: "S2", label: "S2 — Delayed detection, passkey supported", href: "/passkeysignup/scenario-2" },
  { id: "S3", label: "S3 — Passkey not supported",               href: "/passkeysignup/scenario-3" },
  { id: "S4", label: "S4 — User opts out during loader",         href: "/passkeysignup/scenario-4" },
  { id: "S5", label: "S5 — User cancels native prompt",          href: "/passkeysignup/scenario-5" },
];
      ...
      <div style={{
        ...
        {SCENARIOS.map((s) => (
          <Link key={s.id} href={s.href} style={{
            ...
            background: s.id === "S1" ? "#111" : "transparent",
            color: s.id === "S1" ? "#fff" : "#666",
